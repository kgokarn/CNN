    ...
    while(iter<25):
        ...
        while(ii<25):
            ...
            async def test_cnn_hw(dut):
                ...
                layer2[count, count2, 0] = dut.o_output_0
                layer2[count, count2, 1] = dut.o_output_1
                layer2[count, count2, 2] = dut.o_output_2
                layer2[count, count2, 3] = dut.o_output_3
                layer2[count, count2, 4] = dut.o_output_4
                layer2[count, count2, 5] = dut.o_output_5
                layer2[count, count2, 6] = dut.o_output_6
                layer2[count, count2, 7] = dut.o_output_7
                layer2[count, count2, 8]  = dut.o_output_8
                layer2[count, count2, 9] = dut.o_output_9
                layer2[count, count2, 10] = dut.o_output_10
                layer2[count, count2, 11] = dut.o_output_11
                layer2[count, count2, 12] = dut.o_output_12
                layer2[count, count2, 13] = dut.o_output_13
                layer2[count, count2, 14] = dut.o_output_14
                layer2[count, count2, 15] = dut.o_output_15
                layer2[count, count2, 16] = dut.o_output_16
                layer2[count, count2, 17] = dut.o_output_17
                layer2[count, count2, 18] = dut.o_output_18
                layer2[count, count2, 19] = dut.o_output_19
