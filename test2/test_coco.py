    ...
    for i, img in enumerate(cnn_data['x_test']):
        ...
        while (iter < 25):
            ...
            while (ii < 25):
                ...
                # print("The new_x is", new_x[0, 0])
                # print("The new_x in fixed point binary is",  fix_pt(new_x[0, 0]))
                # print("value on hardware", dut. i_activation_0_0)                 
                ...
                # print("The value read in test is", dut.o_output_0)
                # print("The value read in float is", fix2float(dut.o_output_0))
                # print("layer2 value is", layer2[count, count2, 0])
